    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>
          Welcome to Vercel Trick By <a href="https://techstorylive.com/">Techstorylive</a>
        </h1>
        ...
        <div className={styles.grid}>
          <a href="https://techstorylive.com/" className={styles.card}>
